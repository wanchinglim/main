...
public class TypicalFlashcards {
    ...
    public static final Flashcard ALICE = new FlashcardBuilder().withTopic("Alice Pauline")
            .withContent("123, Jurong West Ave 6, #08-111").withEmail("alice@example.com")
    ...
    public static final Flashcard AMY =
            ...
            .withEmail(VALID_EMAIL_AMY).withContent(VALID_CONTENT_AMY).withTags(VALID_TAG_FRIEND).build();
    public static final Flashcard BOB =
            new FlashcardBuilder().withTopic(VALID_TOPIC_BOB).withDifficulty(VALID_DIFFICULTY_BOB)
            .withEmail(VALID_EMAIL_BOB).withContent(VALID_CONTENT_BOB).withTags(VALID_TAG_HUSBAND, VALID_TAG_FRIEND)
            .build();
