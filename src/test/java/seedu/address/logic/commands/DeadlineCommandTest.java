...
public class DeadlineCommandTest {
    ...
    public void execute_addDeadlineUnfilteredList_success() {
        ...
        DeadlineCommand deadlineCommand = new DeadlineCommand(INDEX_FIRST_SUBJECT,
    ...
    public void execute_filteredList_success() {
        ...
        Subject editedSubject = new SubjectBuilder(model.getFilteredSubjectList()
                .get(INDEX_FIRST_SUBJECT.getZeroBased())).withDeadline(DEADLINE_STUB).build();
    ...
    public void execute_invalidSubjectIndexUnfilteredList_failure() {
        ...
        assertCommandFailure(deadlineCommand, model, commandHistory, Messages.MESSAGE_INVALID_SUBJECT_DISPLAYED_INDEX);
    }
    ...
    public void executeUndoRedo_validIndexUnfilteredList_success() throws Exception {
        Subject subjectToModify = model.getFilteredSubjectList().get(INDEX_FIRST_SUBJECT.getZeroBased());
        Subject modifiedSubject = new SubjectBuilder(subjectToModify).withDeadline(DEADLINE_STUB).build();
        DeadlineCommand deadlineCommand = new DeadlineCommand(INDEX_FIRST_SUBJECT, new Deadline(DEADLINE_STUB));
        ...
        //undo -> reverts address book back to previous state and filtered subject list to show all subjects
