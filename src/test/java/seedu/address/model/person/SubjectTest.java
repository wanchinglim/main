...
public class SubjectTest {
    ...
    public void isSamePerson() {
        ...
        Subject editedAlice = new PersonBuilder(ALICE).withPhone(VALID_PHONE_BOB).withEmail(VALID_EMAIL_BOB).build();
    ...
    public void equals() {
        ...
        Subject aliceCopy = new PersonBuilder(ALICE).build();
        ...
        // different name -> returns false
        Subject editedAlice = new PersonBuilder(ALICE).withName(VALID_NAME_BOB).build();
