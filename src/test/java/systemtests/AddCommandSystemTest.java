...
*/
        ...
        command = AddCommand.COMMAND_WORD + TOPIC_DESC_BOB + DIFFICULTY_DESC_AMY + CONTENT_DESC_AMY
                + TAG_DESC_FRIEND;
        assertCommandSuccess(command, toAdd); */

        /* Case: add a flashcard with all fields same as another flashcard in the flash book except difficulty
         * -> added

        toAdd = new FlashcardBuilder(AMY).withDifficulty(VALID_DIFFICULTY_BOB).build();
        ...
        toAdd = BOB;
        command = AddCommand.COMMAND_WORD + TAG_DESC_FRIEND + DIFFICULTY_DESC_BOB + CONTENT_DESC_BOB + TOPIC_DESC_BOB
                + TAG_DESC_HUSBAND;
        assertCommandSuccess(command, toAdd);*/
        ...
        toAdd = new FlashcardBuilder(HOON).withContent(VALID_CONTENT_BOB).build();
        command = FlashcardUtil.getAddCommand(toAdd);
        assertCommandFailure(command, AddCommand.MESSAGE_DUPLICATE_FLASHCARD);*/
        ...
        command = AddCommand.COMMAND_WORD + DIFFICULTY_DESC_AMY + CONTENT_DESC_AMY;
        assertCommandFailure(command, String.format(MESSAGE_INVALID_COMMAND_FORMAT, AddCommand.MESSAGE_USAGE));*/

        /* Case: missing difficulty -> rejected
        command = AddCommand.COMMAND_WORD + TOPIC_DESC_AMY + CONTENT_DESC_AMY;
        assertCommandFailure(command, String.format(MESSAGE_INVALID_COMMAND_FORMAT, AddCommand.MESSAGE_USAGE));*/

        /* Case: missing content -> rejected
        command = AddCommand.COMMAND_WORD + TOPIC_DESC_AMY + DIFFICULTY_DESC_AMY;
        assertCommandFailure(command, String.format(MESSAGE_INVALID_COMMAND_FORMAT, AddCommand.MESSAGE_USAGE));*/
        ...
        command = AddCommand.COMMAND_WORD + TOPIC_DESC_AMY + INVALID_DIFFICULTY_DESC
                + CONTENT_DESC_AMY;
