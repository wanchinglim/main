...
public class DeleteCommandSystemTest extends AddressBookSystemTest {
    ...
    public void delete() {
        ...
        Subject deletedSubject = removePerson(expectedModel, INDEX_FIRST_PERSON);
        String expectedResultMessage = String.format(MESSAGE_DELETE_PERSON_SUCCESS, deletedSubject);
        ...
        deletedSubject = removePerson(expectedModel, selectedIndex);
        expectedResultMessage = String.format(MESSAGE_DELETE_PERSON_SUCCESS, deletedSubject);
     ...
     */
    private Subject removePerson(Model model, Index index) {
        Subject targetSubject = getPerson(model, index);
        model.deletePerson(targetSubject);
    ...
    private void assertCommandSuccess(Index toDelete) {
        Model expectedModel = getModel();
        Subject deletedSubject = removePerson(expectedModel, toDelete);
        String expectedResultMessage = String.format(MESSAGE_DELETE_PERSON_SUCCESS, deletedSubject);
