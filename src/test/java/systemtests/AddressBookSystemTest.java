...
public abstract class AddressBookSystemTest {
    ...
    protected void showAllPersons() {
        ...
        assertEquals(getModel().getAddressBook().getPersonList().size(), getModel().getFilteredSubjectList().size());
    }
    ...
    protected void showPersonsWithName(String keyword) {
        ...
        assertTrue(getModel().getFilteredSubjectList().size() < getModel().getAddressBook().getPersonList().size());
    }
     ...
     * and the subject list panel displays the persons in the model correctly.
     */
    protected void assertApplicationDisplaysExpected(String expectedCommandInput, String expectedResultMessage,
        ...
        assertListMatching(getPersonListPanel(), expectedModel.getFilteredSubjectList());
    }
    ...
    private void assertApplicationStartingStateIsCorrect() {
        ...
        assertListMatching(getPersonListPanel(), getModel().getFilteredSubjectList());
        assertEquals(BrowserPanel.DEFAULT_PAGE, getBrowserPanel().getLoadedUrl());
