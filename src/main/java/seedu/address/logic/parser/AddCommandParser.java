...
public class AddCommandParser implements Parser<AddCommand> {
    ...
    public AddCommand parse(String args) throws ParseException {
        ArgumentMultimap argMultimap =
                ArgumentTokenizer.tokenize(args, PREFIX_TOPIC, PREFIX_PHONE, PREFIX_EMAIL, PREFIX_ADDRESS, PREFIX_TAG);

        if (!arePrefixesPresent(argMultimap, PREFIX_TOPIC, PREFIX_ADDRESS, PREFIX_PHONE, PREFIX_EMAIL)
        ...
        Flashcard flashcard = new Flashcard(topic, phone, email, address, deadline, tagList);
