...
/**
 * Finds and lists all flashcards in address book whose name contains any of the argument keywords.
...
public class FindCommand extends Command {
    ...
    public FindCommand(ContentContainsKeywordsPredicate predicate) {
