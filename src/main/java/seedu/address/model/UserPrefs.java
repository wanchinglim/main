...
public class UserPrefs implements ReadOnlyUserPrefs {
    ...
    public void resetData(ReadOnlyUserPrefs newUserPrefs) {
        ...
        setFlashBookFilePath(newUserPrefs.getFlashBookFilePath());
    }
    ...
    public void setFlashBookFilePath(Path addressBookFilePath) {
        requireNonNull(addressBookFilePath);
        this.flashBookFilePath = addressBookFilePath;
    }
    ...
    public boolean equals(Object other) {
        ...
        return guiSettings.equals(o.guiSettings)
                && flashBookFilePath.equals(o.flashBookFilePath);
    }

    @Override
    public int hashCode() {
        return Objects.hash(guiSettings, flashBookFilePath);
    }
