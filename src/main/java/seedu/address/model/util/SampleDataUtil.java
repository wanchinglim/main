...
public class SampleDataUtil {
    ...
    public static Flashcard[] getSampleFlashcards() {
        return new Flashcard[] {
            new Flashcard(new Topic("Math"), new Phone("87438807"), new Email("alexyeoh@example.com"),
                new Address("Blk 30 Geylang Street 29, #06-40"), EMPTY_DEADLINE,
                getTagSet("friends")),
            new Flashcard(new Topic("Science"), new Phone("99272758"), new Email("berniceyu@example.com"),
                new Address("Blk 30 Lorong 3 Serangoon Gardens, #07-18"), EMPTY_DEADLINE,
                getTagSet("colleagues", "friends")),
            new Flashcard(new Topic("Chinese"), new Phone("93210283"), new Email("charlotte@example.com"),
                new Address("Blk 11 Ang Mo Kio Street 74, #11-04"), EMPTY_DEADLINE,
                getTagSet("neighbours")),
            new Flashcard(new Topic("Geography"), new Phone("91031282"), new Email("lidavid@example.com"),
                new Address("Blk 436 Serangoon Gardens Street 26, #16-43"), EMPTY_DEADLINE,
                getTagSet("family")),
            new Flashcard(new Topic("Chemistry"), new Phone("92492021"), new Email("irfan@example.com"),
                new Address("Blk 47 Tampines Street 20, #17-35"), EMPTY_DEADLINE,
                getTagSet("classmates")),
            new Flashcard(new Topic("Physics"), new Phone("92624417"), new Email("royb@example.com"),
