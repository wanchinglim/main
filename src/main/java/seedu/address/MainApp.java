...
public class MainApp extends Application {
    ...
    public void init() throws Exception {
        logger.info("=============================[ Initializing FlashBook ]===========================");
        super.init();
    ...
    /**
     * Returns a {@code ModelManager} with the data from {@code storage}'s flash book and {@code userPrefs}. <br>
     * The data from the sample flash book will be used instead if {@code storage}'s flash book is not found,
     * or an empty flash book will be used instead if errors occur when reading {@code storage}'s flash book.
     */
    ...
    public void start(Stage primaryStage) {
        logger.info("Starting FlashBook " + MainApp.VERSION);
        ui.start(primaryStage);
    }

    @Override
    public void stop() {
        logger.info("============================ [ Stopping Flash Book ] =============================");
        try {
