...
* `FlashCards#s()` -- (skip) Skip the current flash card and move on to the next. The flash card skipped will move to the back of the line. [Coming in v2.0]
* `FlashCards#c()` -- (change) Closes the flash cards in the current flashcard and move on to the next flashcard selected/in line. [Coming in v2.0]
...
* `"Focus" Subject Testing Mode` [Coming in v2.0]
