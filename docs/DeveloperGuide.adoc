...
For each flashcard the user has, he/she can create flash cards specifically for the topic. The user can also choose the testing mode he/she wishes to be tested on. These are the different modes available: +
=======
...
|`* * *` |User |Delete a flash card |Remove flashcards that I no longer need
...
|`* *` |User |Categorize each flash card by importance |Prioritise which information to study or memorise first
