...
-- From the pool of flash cards under the selected flashcard, the user will choose the number of flash cards and there will be a mixture of frequency levels from the flashcard pool. This mode will focus on a specific flashcard and can be used for revision before mini quizzes held in school.
...
|`* *` |User |Locate the next flash card |Easily navigate to next flashcard

|`* *` |User |Locate the previous flash card |Easily go back to the previous flashcard

|`*` |User |View flashcards based on difficulty |View flashcards that are difficult or easy first

|`*` |User |View flashcards in a random manner |View flashcards that have a mixture of difficulty level
