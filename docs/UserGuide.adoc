...
Next, enter `edit 1 s/Science` or `e 1 s/Science` to edit the flashcard with index "1", and replace its existing subject with "Science".
...
Next, enter `edit 2 c/The quick brown fox` or `e 2 c/The quick brown fox` to edit the flashcard with index "2", and replace its existing content with "The quick brown fox".
