...
and the user has to interact with the application mainly through a Command Line Interface (CLI).
...
This section will document the summary of features that I have coded, other helpful contributions to this project, and documentations done for this application.
...
Since flashcards are categorized based on their subject, users will be able to focus on a particular subject's notes when studying.
** *Highlights:* This enhancement affects the existing GUI and `add` command.
It helps the user to automatically categorize flashcards based on their subject without any additional steps.
...
** *What is it:* Added colours to each subject tag so that different tags will have different colours.
...
=== Other Contributions
** *Project management:*
*** Managed relevant documentations (e.g. User Guide, About Us etc.) by ensuring everything is correct and well-documented.
...
=== Other Contributions
Due to space constraints, you can find the remaining documentations that I have done for the user guide in the links below:
...
This guide contains all information regarding the development of this application, and the following will show an excerpt of it that was written by me.
I took charge of the **Quizzing by Subject** section since it was the feature I developed for this project._
|===
